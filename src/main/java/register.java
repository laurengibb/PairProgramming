...
public class register {
    ...
    private WebElement createAddress1;
    ...
    private WebElement createAddress2;
    ...
    private WebElement createState;
    ...
    private WebElement createPostcode;
    ...
    private WebElement createCountry;
    ...
    public void creating(){
        ...
        createFirstName.sendKeys(importData.FirstName);
        createLastName.sendKeys(importData.LastName);
        createPhone.sendKeys(importData.Phone);
        createEmail.sendKeys(importData.Email);
        createAddress1.sendKeys(importData.Address1);
        createAddress2.sendKeys(importData.Address2);
        createCity.sendKeys(importData.City);
        createState.sendKeys(importData.State);
        createPostcode.sendKeys(importData.Postcode);
        createCountry.sendKeys(importData.Country);
        createUserName.sendKeys(importData.UserName);
        createPassword.sendKeys(importData.Password);
        createConfirmPassword.sendKeys(importData.ConfirmPassword);
        createSubmit.submit();
